...
#filters to just include 14:00 to 16:00 data

garmet$hour <- format(as.POSIXct(garmet$measure_date,format="%H:%M:%S"),"%H")

garmet <- garmet[garmet$hour==15 | garmet$hour==15,]
